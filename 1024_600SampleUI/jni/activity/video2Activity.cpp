...
static ZKButton* mButtont3Ptr;
static ZKButton* mButtont2Ptr;
static ZKButton* mButtont1Ptr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_VIDEO2_Buttont3, onButtonClick_Buttont3,
    ID_VIDEO2_Buttont2, onButtonClick_Buttont2,
    ID_VIDEO2_Buttont1, onButtonClick_Buttont1,
...
void video2Activity::onCreate() {
	Activity::onCreate();
    mButtont3Ptr = (ZKButton*)findControlByID(ID_VIDEO2_Buttont3);
    mButtont2Ptr = (ZKButton*)findControlByID(ID_VIDEO2_Buttont2);
    mButtont1Ptr = (ZKButton*)findControlByID(ID_VIDEO2_Buttont1);
