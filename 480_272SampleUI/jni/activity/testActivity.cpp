...
static ZKButton* mButtonTestPtr;
static ZKTextView* mTextview10Ptr;
static ZKTextView* mTextview7Ptr;
static ZKTextView* mTextviewRecPtr;
static ZKTextView* mTextviewSendPtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ...
    ID_TEST_ButtonTest, onButtonClick_ButtonTest,
};
/***************/
...
void testActivity::onCreate() {
    ...
    mButtonTestPtr = (ZKButton*)findControlByID(ID_TEST_ButtonTest);
    mTextview10Ptr = (ZKTextView*)findControlByID(ID_TEST_Textview10);
    mTextview7Ptr = (ZKTextView*)findControlByID(ID_TEST_Textview7);
    mTextviewRecPtr = (ZKTextView*)findControlByID(ID_TEST_TextviewRec);
    mTextviewSendPtr = (ZKTextView*)findControlByID(ID_TEST_TextviewSend);
	onUI_init();
        // 注册监听全局触摸
