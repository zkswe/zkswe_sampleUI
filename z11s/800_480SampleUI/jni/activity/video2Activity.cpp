...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_VIDEO2_ButtonSound, onButtonClick_ButtonSound,
    ID_VIDEO2_ButtonZoom, onButtonClick_ButtonZoom,
    ID_VIDEO2_ButtonPre, onButtonClick_ButtonPre,
    ID_VIDEO2_ButtonNext, onButtonClick_ButtonNext,
    ID_VIDEO2_ButtonPlay, onButtonClick_ButtonPlay,
...
static S_ZKSeekBarCallback SZKSeekBarCallbackTab[] = {
    ID_VIDEO2_SeekbarSound, onProgressChanged_SeekbarSound,
    ID_VIDEO2_SeekbarProgress, onProgressChanged_SeekbarProgress,
};
...
static S_VideoViewCallback SVideoViewCallbackTab[] = {
    ID_VIDEO2_Videoview1, true, 5, NULL,
};
...
void video2Activity::onCreate() {
	Activity::onCreate();
    mButtonSoundPtr = (ZKButton*)findControlByID(ID_VIDEO2_ButtonSound);
    mSeekbarSoundPtr = (ZKSeekBar*)findControlByID(ID_VIDEO2_SeekbarSound);if(mSeekbarSoundPtr!= NULL){mSeekbarSoundPtr->setSeekBarChangeListener(this);}
    mButtonZoomPtr = (ZKButton*)findControlByID(ID_VIDEO2_ButtonZoom);
    mButtonPrePtr = (ZKButton*)findControlByID(ID_VIDEO2_ButtonPre);
    mButtonNextPtr = (ZKButton*)findControlByID(ID_VIDEO2_ButtonNext);
    mButtonPlayPtr = (ZKButton*)findControlByID(ID_VIDEO2_ButtonPlay);
    mSeekbarProgressPtr = (ZKSeekBar*)findControlByID(ID_VIDEO2_SeekbarProgress);if(mSeekbarProgressPtr!= NULL){mSeekbarProgressPtr->setSeekBarChangeListener(this);}
    msys_backPtr = (ZKButton*)findControlByID(ID_VIDEO2_sys_back);
    mVideoview1Ptr = (ZKVideoView*)findControlByID(ID_VIDEO2_Videoview1);if(mVideoview1Ptr!= NULL){mVideoview1Ptr->setVideoPlayerMessageListener(this);}
	onUI_init();
        // 注册监听全局触摸
