...
static ZKButton* mPauseButtonPtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ...
    ID_MUSIC_StopButton, onButtonClick_StopButton,
    ID_MUSIC_PauseButton, onButtonClick_PauseButton,
    ID_MUSIC_PlayButton, onButtonClick_PlayButton,
};
/***************/
...
static S_ZKSeekBarCallback SZKSeekBarCallbackTab[] = {
    ID_MUSIC_Seekbar1, onProgressChanged_Seekbar1,
};
...
void musicActivity::onCreate() {
    ...
    mSeekbar1Ptr = (ZKSeekBar*)findControlByID(ID_MUSIC_Seekbar1);if(mSeekbar1Ptr!= NULL){mSeekbar1Ptr->setSeekBarChangeListener(this);}
    mTextview2Ptr = (ZKTextView*)findControlByID(ID_MUSIC_Textview2);
    mStopButtonPtr = (ZKButton*)findControlByID(ID_MUSIC_StopButton);
    mPauseButtonPtr = (ZKButton*)findControlByID(ID_MUSIC_PauseButton);
    mTextview1Ptr = (ZKTextView*)findControlByID(ID_MUSIC_Textview1);
    mPlayButtonPtr = (ZKButton*)findControlByID(ID_MUSIC_PlayButton);
	mActivityPtr = this;
	onUI_init();
